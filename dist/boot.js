 ...
 */
export function runBoot(inv) {
    const args = ['--profile', inv.profileName];
    if (inv.probeOverlayPath !== null)
        args.push('--patch', inv.probeOverlayPath);
    ...
    const env = { ...process.env, DSH_HOME: inv.home };
    if (inv.disableTelemetry)
    ...
    const ready = () => readyUrlSeen || probe !== null;
